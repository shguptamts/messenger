...
import org.shgup.ss.messenger.service.CommentService;
...
public class CommentResource {
	...
	@PUT
	@Path("/{commentId}")
	public Comment updtaeComment(@PathParam("messageId") long messageId ,@PathParam("commentId") long commentId, Comment comment)
	{
